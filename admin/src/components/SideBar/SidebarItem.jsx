...
export default function SidebarItem({ text, href = "/", children }) {
  ...
  return (
    <>
      <div className="bg-black dark:bg-white dark:text-black text-white p-2 rounded w-[100px] sm:w-[200px] font-bold shadow-[2px_2px_1px_blue] flex items-center justify-center cursor-pointer my-5">
        <Link
          to={href}
