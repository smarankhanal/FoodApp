  ...
  return (
    <div className=" dark:text-black text-white  mt-10 ml-5 p-4 flex-1 max-w-fit max-h-fit">
      <div className="grid grid-cols-3 gap-20 pl-20">
        <div className="h-[200px] w-[200px] dark:bg-white bg-black flex flex-col items-center justify-center rounded-lg text-blue-600 font-serif shadow-[2px_2px_1px_blue]">
